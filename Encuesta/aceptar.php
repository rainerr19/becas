<?php
    ...
    $verificar_correo = mysqli_query($conexion, "SELECT * FROM encuesta_ingreso_policia WHERE correo ='$correo' and estado='Aceptado' ");
...
$nombre = $row["nombre"];
     ...
     if (mysqli_num_rows($verificar_correo) >0){
        echo '
        <script>
        alert ("El usuario ya ha sido aceptado anteriormente");
        ...
        exit;
            ...
            $cuerpo = "Estimado $nombre: <br/> la encuesta que ha realizado ha sido aceptada <br/>";
            $mail = new PHPMailer();
